  ...
  const experiences = [
    {
      ...
      description: 'Lidero o desenvolvimento de aplicações web escaláveis usando React, Node.js e AWS. Responsável pela arquitetura de microserviços e mentoria de desenvolvedores júniores.',
    ...
    },
    {
      ...
      company: 'StartupXYZ',
      period: '2022 - 2023',
      description: 'Desenvolveu do zero uma plataforma SaaS que atende mais de 10.000 usuários. Implementei features de pagamento, autenticação e dashboard analytics.',
